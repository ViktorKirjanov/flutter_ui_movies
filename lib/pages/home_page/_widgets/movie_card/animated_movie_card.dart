...
import 'package:flutter_ui_movies/pages/home_page/_widgets/movie_card/header_transform_offset.dart';
...
class _AnimatedMovieCardState extends State<AnimatedMovieCard>
  ...
  void _forward() {
    ...
    Future<void>.delayed(const Duration(milliseconds: 425))
          ...
          child: Center(
            child: AnimatedBuilder(
              ...
              builder: (_, child) => Container(
                ...
                width: startWidth +
                    _widthAnimationController.value * (size.width - startWidth),
  ...
  Widget _buildMovieDescription() => IgnorePointer(
        ignoring: ignorePointer,
        child: Padding(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, index) => ActorAnimation(
  ...
  Widget _buildActor(int index, Actor actor) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
  ...
  Widget _buildMoreHoriz() => AnimatedBuilder(
